...
<div class="main-content">
    <div class="wrapper">
        ...
        <a href="<?php echo 'http://localhost/coffee/';?>admin/add-food.php" class="btn-primary">Add Food</a>
        <br /> <br /> <br />
        ...
        <table class="tbl-full">
            ...
            <tr>
                ...
                <td><?php 
                     ...
                     {
                          ?>
                    <img src="<?php echo 'http://localhost/coffee/';?>images/food/<?php echo $image_name; ?>"
                        width="100px">
                    <?php
                     }
                     else{
