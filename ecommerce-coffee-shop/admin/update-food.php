                    ...
                    <td>
                        ...
                        if($current_image =="")
                        {
                            ...
                            echo "<div class='error'>Image not Added.</div>";
                             ...
                             ?>
                        <img src="<?php echo 'http://localhost/coffee/';?>images/food/<?php echo $current_image; ?>"
                            width="100px" ;>
                        <?php
                ...
                <tr>
                    ...
                    <td>
                        <select name="category">
                            ...
                            <?php 
                            // show category in category select option
        ...
        <?php 
          if(isset($_POST['submit']))
          {
                ...
                if($image_name!="")
             {
                ...
                //rename image
                $image_name="Food_Name_" .rand(0000, 9999) .'.'.$ext; // e.g Food_update_834.jpg or png
