...
<body>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown04">
                            ...
                            <a class="dropdown-item" href="<?php echo 'http://localhost/coffee/';?>cart.php">Cart</a>
                            <a class="dropdown-item"
                                href="<?php echo 'http://localhost/coffee/';?>checkout.php">Checkout</a>
                        </div>
                    </li>
    ...
    <section class="ftco-section">
        <div class="container">
            <div class="row justify-content-center mb-5 pb-3">
                <div class="col-md-7 heading-section ftco-animate text-center">
                    ...
                    <br>
                    <h2 class="mb-4">Our Food Categories</h2>
        ...
        <div class="row">
            ...
            <?php 
        //create sql query to display categories from database or admin panel
        $sql="SELECT * FROM tbl_category LIMIT 6";
        
        //execute querry
        $res=mysqli_query($conn, $sql);
          
        //count rows to check category is availabe or not
           ...
           while($row=mysqli_fetch_assoc($res))
           {
            ...
            <div class="col-md-3">
                <div class="menu-entry">
                    ...
                    <a href="<?php echo 'http://localhost/coffee/'; ?>category-food.php?category_id=<?php echo $id; ?>"
                        class="img"
                        style="background-image: url(<?php echo SITEURL; ?>images/category/<?php echo $image_name;?>);"></a>
                    <?php
                         }
                     ?>
