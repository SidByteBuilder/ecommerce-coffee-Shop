        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a href="<?php echo 'http://localhost/coffee/';?>blog.php"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown04">
                            <a class="dropdown-item" href="<?php echo 'http://localhost/coffee/';?>shop.php">Shop</a>
                ...
                <div class="row slider-text justify-content-center align-items-center">
                    ...
                    <div class="col-md-7 col-sm-12 text-center ftco-animate">
                        ...
                        <p class="breadcrumbs"><span class="mr-2"><a
                                    href="<?php echo 'http://localhost/coffee/';?>">Home</a></span> <span>Blog</span>
                        </p>
                    </div>
